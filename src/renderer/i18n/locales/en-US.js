export default {
  ...
  SIGN_VERIFY: {
    ...
    SIGN_DELEGATE_TRANSACTION: 'Sign and export genesis delegate transaction',
    SIGN_DELEGATE_TRANSACTION_FOR_EXPORT: 'Sign a genesis delegate register transaction and export it in json',
    SIGN: 'Sign',
    VERIFY: 'Verify',
    EXPORT: 'Export',
    TITLE_SIGN: 'Sign a message',
    TITLE_VERIFY: 'Verify a message',
    TITLE_DELEGATE_TRANSACTION: 'Genesis delegate transaction',
